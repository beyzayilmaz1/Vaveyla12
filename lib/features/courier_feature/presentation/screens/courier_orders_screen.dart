              ...
              builder: (context, orders) {
                ...
                final delivered =
                    orders
                        ...
                        .length;
                final declined =
                    orders.where((o) => o.courierDeclined).length;
                return TabBar(
          ...
          builder: (context, orders) {
            return TabBarView(
              ...
              children: [
                ...
                _OrdersList(
                  orders:
                      orders.where((o) => o.courierDeclined).toList(),
                  status: CourierOrderStatus.assigned,
                  tabController: _tabController,
                  isDeclinedTab: true,
                ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Builder(
                          builder: (context) {
                            final customerLine =
                                _courierOrderCustomerSummary(order);
                                ...
                                Expanded(
                                  child: Text(
                                    order.courierDeclineReason != null &&
                                            order.courierDeclineReason!.trim()
                                                .isNotEmpty
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: typography.labelSmall.copyWith(
                                color:
                                    order.courierDeclined ? colors.error : accent,
                                fontWeight: FontWeight.w600,
                              ),
                            ),
                          ],
